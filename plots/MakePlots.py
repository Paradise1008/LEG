...
def create_grid_SenPlot(dfs,filename,colors=None,markers=None,line_styles=None, titles=None,nrow=2, ncol=2, my_dpi=400):
    if colors is None:
...
if __name__ == "__main__":
    ...
    METHODS = {'LEG':sa_leg , 'LEGTV':sa_leg_tv, 'saliency':sa_sal  , 'deeplift':sa_dl , 'elrp':sa_elrp, 'occ': sa_occ, 'sv':sa_sv}
    ...
    for i in range(4):
        ...
        PLOT_DATA.append(df)
    markers = ['']*10
    create_grid_SenPlot(PLOT_DATA,'MNIST_SEN.pdf',colors=None,markers=markers,line_styles=None, titles=None,nrow=1, ncol=4)
